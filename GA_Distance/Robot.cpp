...
std::vector<double> Robot::getMorphParameters2(){
    std::vector<double> output(15);
    output = {morphParams[7], morphParams[9], morphParams[10], morphParams[12], morphParams[14], morphParams[15], morphParams[18], morphParams[20], morphParams[21], morphParams[23], morphParams[25], morphParams[26]};
    return output;
}
...
void Robot::setParameters(std::vector<double> Params){
    cpgParams = {Params[0], Params[1], Params[2]};
    std::vector<double>bodyParams {1, 0.5, 10, 1000, 0};
    std::vector<double>frontLegParams = {2,0.03};
    frontLegParams.push_back(Params[3]);
    frontLegParams.push_back(1);
    frontLegParams.push_back(Params[4]);
    frontLegParams.push_back(Params[5]);
    frontLegParams.push_back(0.03);
    frontLegParams.push_back(Params[6]);
    frontLegParams.push_back(1);
    frontLegParams.push_back(Params[7]);
    frontLegParams.push_back(Params[8]);
    std::vector<double>backLegParams {2, 0.03};
    backLegParams.push_back(Params[9]);
    backLegParams.push_back(1);
    backLegParams.push_back(Params[10]);
    backLegParams.push_back(Params[11]);
    backLegParams.push_back(0.03);
    backLegParams.push_back(Params[12]);
    backLegParams.push_back(1);
    backLegParams.push_back(Params[13]);
    backLegParams.push_back(Params[14]);
...
void Robot::evaluateFitness(bool show){
    std::string filePathString = "/Users/JeanBaptisteBolh/Documents/School/CS352/Final/ode-0.12-drawstuff-master/ode/demo/robo_sim";
