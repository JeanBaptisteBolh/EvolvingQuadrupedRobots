...
void Population::writeGenerationStatsForRun(int genNum, int runNum){
    std::ofstream myfile;
    std::string name = "/Users/JeanBaptisteBolh/Documents/School/CS352/Final/GA_COT_CPG/Outputs/Run_" + std::to_string(runNum) + ".txt";
...
void Population::writeWholePopulationToFile(int genNum){
    std::ofstream myfile;
    std::string name = "/Users/JeanBaptisteBolh/Documents/School/CS352/Final/GA_COT_CPG/Outputs/Gen_" + std::to_string(genNum) + ".txt";
    myfile.open (name, std::ios::app);
    for(int i=0; i<popSize; i++){
