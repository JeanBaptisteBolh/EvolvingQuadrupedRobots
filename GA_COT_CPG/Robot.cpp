...
std::vector<double> Robot::setRandomMorphParams() {
    ...
    //num front leg segs, flseg radius, length, mass, spring k, angle
    std::vector<double>frontLegParams {2, 0.03, 0.14, 1, 0, 0, 0.03, 0.14, 1, 100, -0.523};

    //num back leg segs, bl seg radius, length, mass, spring k, angle
    std::vector<double>backLegParams {2, 0.03, 0.14, 1, 0, 0, 0.03, 0.14, 1, 100, -0.5233};
